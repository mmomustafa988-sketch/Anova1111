...
export type ProviderStatusType = 'Working' | 'Broken' | 'Sandbox' | 'Blocked' | 'Timeout' | 'Unknown';
...
export interface Episode {
  ...
  title?: string;
  filler?: boolean;
  videoSources?: Record<string, any> | any[];
  availableLanguages?: AudioLanguageTrack[];
  availableSources?: PlaybackProvider[];
  lastCheckedTime?: number;
}
